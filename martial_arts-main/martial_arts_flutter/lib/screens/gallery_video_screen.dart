...
class GalleryVideoScreen extends StatefulWidget {
  ...
  const GalleryVideoScreen(
      {Key? key, required this.refVideoTitle, required this.expertVideoUrl})
      : super(key: key);
...
class _GalleryVideoScreenState extends State<GalleryVideoScreen> {
      ...
      if (video != null) {
        ...
        _chewieController = ChewieController(
          ...
          materialProgressColors: ChewieProgressColors(
            ...
            bufferedColor: AppTheme.accentColor.withOpacity(0.5),
          ),
        );
  ...
  Future<void> _analyzeVideo() async {
    ...
    try {
      ...
      request.files.add(
          await http.MultipartFile.fromPath('user_video', _videoFile!.path));
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.pushNamedAndRemoveUntil(
          ...
          arguments: {
            ...
            // Use a placeholder or fetch from API
          },
        );
      } else {
        if (!mounted) return;
